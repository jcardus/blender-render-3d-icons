...
FILE_FILTER=veh_sedan_01 RECURSIVE=1 UNLIT=0 EXTENSIONS="obj" MODEL_DIR="./city_veh" TEXTURES_DIR=./textures TEXTURE_FILE=./textures/city_vehicles_pallete.png OUTPUT_PATH="$OUTPUT_PATH" blender -b -P render.py
